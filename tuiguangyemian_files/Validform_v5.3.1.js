...
(function($,win,undef){
	...
	function creatMsgbox(){
		...
		msgobj=$('<div id="Validform_msg"><div class="Validform_title">'+tipmsg.tit+'</div><div class="Validform_info"></div><div class="Validform_close"><button>我知道了</button></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>').appendTo("body");//提示信息框;
		msgobj.find(".Validform_close").click(function(){
			msgobj.hide();
			msghidden=true;
			if(errorobj){
